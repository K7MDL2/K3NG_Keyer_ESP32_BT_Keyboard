...
#define USER_SETUP_INFO "User_Setup_DIYMalls_240x320"
...
#define TOUCH_IRQ  17   // optional: input-only; we only read its level
//Touch IRQ is 36 pulled up to 3.3V so not used

...
#ifdef USER_SETUP_LOADED //  Lets PlatformIO users define settings in
...
#include "../../main/keyer_features_and_options_esp32_dev.h"
     ...
     #include "../../main/TFT_e_SPI_Custom_Config/User_Setup_IdeaSpark_170x320.h"
#elif FEATURE_TFT7789_3_2inch_240x320_LCD
     #include "../../main/TFT_e_SPI_Custom_Config/User_Setup_DIYMalls_240x320.h"
#else

// keyer_dependencies.h
...
#if defined(FEATURE_LCD_4BIT) || defined(FEATURE_LCD_8BIT) || defined(FEATURE_LCD_ADAFRUIT_I2C) \
  || defined(FEATURE_LCD_ADAFRUIT_BACKPACK) || defined(FEATURE_LCD_YDv1) ||defined(FEATURE_LCD1602_N07DH) \
  || defined(FEATURE_LCD_SAINSMART_I2C) || defined(FEATURE_M5STACK_CORE2) \
  ...
  || defined(FEATURE_TFT_TEENSY_RA887x_CAP_LCD)
...
#if defined(FEATURE_BT_KEYBOARD) && (!defined(HARDWARE_ESP32_DEV) && !defined(ARDUINO_RASPBERRY_PI_PICO_W))

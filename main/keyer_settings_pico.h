...
#define eeprom_write_time_ms 30000
  ...
  #define analog_buttons_number_of_buttons 1 // For Keypad only command button is neaded 6 //4  // includes the command button (command button + 3 memory buttons = 4) //sp5iou 20180319
...
// If you have BUTTON_ROWS == 2, only the top 8 buttons (B1-B8) will show. The rest are unavailable on screen and ignored.
...
// There cannot be any typos and there must be exactly 16 or you will get compile errors
...
// Put them in your priority order.  Use the '\' char at the end of each of the first 3 lines to break the long line into multiple lines
  ...
  #else //  (FEATURE_TFT_320x480_CAP_LCD) and others

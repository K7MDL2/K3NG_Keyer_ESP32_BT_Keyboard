...
#define CODE_VERSION "V:K7MDL-2026.6.7"
...
#define NO_DISPLAY               0
#define TEENSY_NO_DISPLAY        1
#define TEENSY_RA887x_DISPLAY    2
...
//#define DISPLAY_TYPE TEENSY_NO_DISPLAY  // Teensy 4
#define DISPLAY_TYPE TEENSY_RA887x_DISPLAY
...
#if (DISPLAY_TYPE == TEENSY_RA887x_DISPLAY)
    #define USE_RA8876
    #define FEATURE_TFT_TEENSY_RA887x_CAP_LCD     // K7MDL version on ESP32-WROOM with onboard 3.2" DIYMalls ST7789 240x320 color LCD graphics display, uses SPI bus         

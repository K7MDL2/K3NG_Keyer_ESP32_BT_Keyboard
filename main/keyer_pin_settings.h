...
//#else // ESP-WROOM-32, 27, 5 33, Teensy

  #define I2CDEV_SDA_PIN  18   // override the sdkconfig pair of 21, 22
  #define I2CDEV_SCL_PIN  19
  ...
  #define paddle_right      4 //33 Needs external 10k Pullup. 33 can be used as touch paddle on ESP32 platform //SP5IOU 20220201
  #define tx_key_line_1     41  // (high = key down/tx on)
  #define sidetone_line     32 //23         // connect a speaker for sidetone
  ...
  #define tx_pause_pin      0
    ...
    #define pin_straight_key 0 //TXD0
